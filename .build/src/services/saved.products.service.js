...
var removeSaved = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, product_id, product, save;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                save = _a.sent();
                if (!save) {
                    throw new error_response_1.ErrorResponse("Product/User ID not found", http_status_1.default.NOT_FOUND);
                }
                return [4 /*yield*/, save.destroy()];
            case 3:
                _a.sent();
                return [2 /*return*/, "Product unsaved"];
        }
    });
}); };
...
var checkSaved = function (user_id, product_id) { return __awaiter(void 0, void 0, void 0, function () {
    var product, save;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                save = _a.sent();
                if (!save) {
                    return [2 /*return*/, { is_saved: false }];
                }
                return [2 /*return*/, { is_saved: true }];
        }
    });
}); };
