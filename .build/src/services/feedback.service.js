    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                feedback = _a.sent();
                if (!feedback) {
                    throw new error_response_1.ErrorResponse("No feedback found", http_status_1.default.NOT_FOUND);
                }
...
var update = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var feedback_id, status, user_level, feedback;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, findOne(feedback_id)];
            case 1:
                feedback = _a.sent();
...
var findAll = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var paginateOptions, status, where, feedbacks;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
