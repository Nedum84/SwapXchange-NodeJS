    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, coins_service_1.default.create(__assign({ user_id: user_id }, req.body))];
            case 1:
                result = _a.sent();
...
var createForUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, coins_service_1.default.createForUser(req)];
            case 1:
                result = _a.sent();
                api_response_1.default.created(res, result);
                return [2 /*return*/];
...
var getBalance = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user_id = req.user.user_id;
                return [4 /*yield*/, coins_service_1.default.getBalance(user_id)];
            case 1:
                result = _a.sent();
                api_response_1.default.ok(res, result);
                return [2 /*return*/];
