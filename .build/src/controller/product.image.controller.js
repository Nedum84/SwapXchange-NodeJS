...
var product_image_service_1 = __importDefault(require("../services/product.image.service"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, product_image_service_1.default.findOne(image_id)];
            case 1:
                result = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, product_image_service_1.default.findAll(product_id)];
            case 1:
                result = _a.sent();
                api_response_1.default.ok(res, { image_product: result });
                return [2 /*return*/];
...
var deleteOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, product_image_service_1.default.deleteOne(req)];
            case 1:
                result = _a.sent();
                api_response_1.default.ok(res, result, "Image successfully deleted");
                return [2 /*return*/];
        }
    });
}); };
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                body = req.body;
                return [4 /*yield*/, product_image_service_1.default.createOne(body)];
            case 1:
                result = _a.sent();
