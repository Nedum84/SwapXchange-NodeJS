...
var findMe = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                result = _a.sent();
                api_response_1.default.ok(res, { user: result });
                return [2 /*return*/];
        }
    });
}); };
...
var updateUserAddress = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_service_1.default.updateUserAddress(req)];
            case 1:
                result = _a.sent();
                api_response_1.default.ok(res, { user: result });
                return [2 /*return*/];
