...
exports.Role = exports.RtcTokenBuilder = void 0;
...
var RtcTokenBuilder = /** @class */ (function () {
     ...
     */
    RtcTokenBuilder.buildTokenWithUid = function (appID, appCertificate, channelName, uid, role, privilegeExpiredTs) {
     ...
     * @return The new Token.
     */
    RtcTokenBuilder.buildTokenWithAccount = function (appID, appCertificate, channelName, account, role, privilegeExpiredTs) {
        this.key = new AccessToken_1.AccessToken(appID, appCertificate, channelName, account);
        this.key.addPriviledge(AccessToken_2.priviledges.kJoinChannel, privilegeExpiredTs);
        if (role == Role.ATTENDEE || role == Role.PUBLISHER || role == Role.ADMIN) {
            this.key.addPriviledge(AccessToken_2.priviledges.kPublishAudioStream, privilegeExpiredTs);
            this.key.addPriviledge(AccessToken_2.priviledges.kPublishVideoStream, privilegeExpiredTs);
            this.key.addPriviledge(AccessToken_2.priviledges.kPublishDataStream, privilegeExpiredTs);
        }
        return this.key.build();
    };
    return RtcTokenBuilder;
}());
var _RtcTokenBuilder = RtcTokenBuilder;
exports.RtcTokenBuilder = _RtcTokenBuilder;
var _Role = Role;
exports.Role = _Role;
//# sourceMappingURL=RtcTokenBuilder.js.map