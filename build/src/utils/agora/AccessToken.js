...
exports.priviledges = exports.AccessToken = exports.version = void 0;
...
var AccessToken = /** @class */ (function () {
    function AccessToken(appID, appCertificate, channelName, uid) {
        ...
        this.build = function () {
            ...
            var crc_channel = (0, cuint_1.UINT32)((0, crc_32_1.str)(token.channelName))
                .and((0, cuint_1.UINT32)(0xffffffff))
                .toNumber();
            var crc_uid = (0, cuint_1.UINT32)((0, crc_32_1.str)(token.uid)).and((0, cuint_1.UINT32)(0xffffffff)).toNumber();
