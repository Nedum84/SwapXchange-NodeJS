...
var hello = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, todo, name, dynamoDb, item, add, todos, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = JSON.parse(event.body), todo = _a.todo, name = _a.name;
            ...
            case 2:
                _b.trys.push([2, 4, , 5]);
                return [4 /*yield*/, dynamoDb.scan({ TableName: "SwapXTable" }).promise()];
            case 3:
                todos = _b.sent();
                return [3 /*break*/, 5];
            case 4:
