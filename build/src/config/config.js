...
var envVarsSchema = joi_1.default.object()
    ...
    PAYSTACK_TEST_SECRET_KEY: joi_1.default.string().default("key"),
    PAYSTACK_LIVE_SECRET_KEY: joi_1.default.string().default("key"),
...
exports.default = __assign(__assign({}, process.env), { env: envVars.NODE_ENV, PORT: envVars.PORT, REGION: envVars.REGION, NODE_ENV: envVars.NODE_ENV, DB_NAME: envVars.DB_NAME, DB_TEST_NAME: envVars.DB_TEST_NAME, DB_USERNAME: envVars.DB_USERNAME, DB_PASSWORD: envVars.DB_PASSWORD, DB_HOST: envVars.DB_HOST, DB_PORT: envVars.DB_PORT, PAYSTACK_TEST_SECRET_KEY: envVars.PAYSTACK_TEST_SECRET_KEY, PAYSTACK_LIVE_SECRET_KEY: envVars.PAYSTACK_LIVE_SECRET_KEY, AGORA_APP_ID: envVars.AGORA_APP_ID, AGORA_APP_CERT: envVars.AGORA_APP_CERT, jwt: {
